...
<body class="main-layout">
 ...
 while($category = mysqli_fetch_array($result)){
    ...
    <div class='protien'>
        <img src='".$category['image']."'  hight='200px' width='200px' />
        <h3>".$category['price']."</h3>
        <span>". $category['name']." </span>
        <a class='read_more mar_top' href='description.php?id=".$category['id']."'> More Info</a>
    </div>
</div>
    ";
    ...
    <footer>
        <div class="footer">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12">
                        <img class="tex_left" src="images/logoooo.webp" hight='170px' width='170px' alt="#" />
                    </div>
                    <div class=" col-md-3 col-sm-6">
                        <p class="variat">AMH is a company to buy and sel all cars and a special limited cars .</p>
                    </div>
                    <div class="col-lg-2 offset-lg-1 col-md-3 col-sm-6">
                        <h3>Information </h3>
                        <ul class="link_menu">
                            <li> There are many </li>
                            <li> variations of cars</li>
                            <li> sages of class </li>
                            <li> and all class.</li>
                    ...
                    <div class="col-lg-2 offset-lg-1 col-md-3 col-sm-6">
                        <h3>Helpful Links</h3>
                        <ul class="link_menu">
                            <li> <a href="https://www.bmw.com/en/index.html"></a>BMW </li>
                            <li> <a href="https://www.mercedes-benz.com/en/"></a>mercedes</li>
                            <li> <a href="https://www.audi.com/en.html"></a>audi </li>
                            <li> <a href="https://www.volvo.com/en/"></a>volvo </li>
                    ...
                    <div class="col-lg-2 offset-lg-1 col-md-3 col-sm-6">
                        ...
                        <ul class="link_menu">
                            <li> There are many </li>
                            <li> company are supported us </li>
                            <li> sages cham  </li>
